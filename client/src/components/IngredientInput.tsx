  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      {showSuggestions && suggestions.length > 0 && (
        <ul
          role="listbox"
          className="absolute left-0 right-0 z-50 mt-1 bg-[var(--bg-primary)] border border-[var(--border)] rounded-lg shadow-xl max-h-48 overflow-y-auto"
          style={{ top: '100%' }}
        >
          {suggestions.map((s, i) => (
            <li
              ...
              className={`px-3 py-2 cursor-pointer text-sm text-[var(--text)] ${
                i === selectedIndex
